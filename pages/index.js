        ...
        <div className="sidebar">
          ...
          <main>
            ...
            <div className='gallery'>
              ...
              <Link href='/TechCrew'><a><Image className="gallery-image" src={TechCrew_logo} alt="Tech Crew" width='300px'height='300px'/></a></Link>
              <Link href='/FCSC'><a><Image className="gallery-image" src={FCSC_logo} alt="Fundraising and Community Services Comittee" width='300px' height='300px'/></a></Link>
            </div>
          </main>
      </div>
      <Footer />
